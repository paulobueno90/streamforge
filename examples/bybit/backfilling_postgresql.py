...
backfiller = sf.BybitBackfilling(symbol="BTCUSDT", timeframe="1m", from_date="2024-10-01", market_type="LINEAR")
backfiller.register_emitter(db_kline_emitter)
backfiller.run()

# Inverse futures backfilling (note: BTCUSD not BTCUSDT)
backfiller = sf.BybitBackfilling(symbol="BTCUSD", timeframe="1m", from_date="2024-10-01", market_type="INVERSE")
backfiller.register_emitter(db_kline_emitter)
backfiller.run()
